    ...
    <Col xs={12} lg={8}>
      <div className={styles.aboutPage}>
        <div className={styles.info}>
          ...
          <p>
            Durante essa jornada, aprendi muitas coisas legais, inclusive a criar peças personalizadas sob encomenda.
            Aqui, desafio dado é desafio cumprido! :)
          </p>
          <p>Hoje, além da cartonagem, trabalho com semi jóias e bijuterias. Aqui você encontra o presente ideal!</p>
          <p>
            Cada peça que eu produzo, cada detalhe, é feito com amor, dedicação e carinho, pois minha maior recompensa é
            o sorriso no rosto das pessoas.
          </p>
        </div>
