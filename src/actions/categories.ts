...
export const categoryActions = {
  ...
  receiveCategories: (data: Category[]) =>
    createAction(CategoryActionsEnum.RECEIVE_CATEGORIES, data),
  setActiveCategory: (activeCategory: Category) =>
    createAction(CategoryActionsEnum.SET_ACTIVE_CATEGORY, activeCategory),
  ...
  fetchCategory: (id: string) =>
    createAction(CategoryActionsEnum.FETCH_CATEGORY, id),
  upsertCategory: (category: Category) =>
    createAction(CategoryActionsEnum.UPSERT_CATEGORY, category),
  showAdminCategory: (id: string) =>
    createAction(CategoryActionsEnum.SHOW_ADMIN_CATEGORY, id),
  deleteCategory: (id: string) =>
    createAction(CategoryActionsEnum.DELETE_CATEGORY, id),
  changeCategory: (id: string | null) =>
    createAction(CategoryActionsEnum.CHANGE_CATEGORY, id),
};
