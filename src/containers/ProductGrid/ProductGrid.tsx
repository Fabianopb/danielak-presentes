    ...
    <div className={styles.productsView}>
      ...
      >
        <div>
          ...
          <p className="legend">
            Entregue seu projeto em uma caixa personalizada e com estilo
          </p>
        </div>
        <div>
          <img src={carousel2} alt="carousel2" />
          <p className="legend">
            Caixas para fotos 10x15 com encaixe para pendrive ou pencard
          </p>
        </div>
        <div>
          <img src={carousel3} alt="carousel3" />
          <p className="legend">
            Um jeito diferente e especial de tratar seus clientes
          </p>
        </div>
      </Carousel>
      <h3>Produtos</h3>
          ...
          products.data.map((product: Product) => {
            return (
              <div
                ...
                onClick={() =>
                  routerActions.push(
                    `/product/${product._id}${router.location.search}`
                  )
                }
              >
                ...
                <div className={styles.currentPrice}>
                  <span
                    className={
                      product.discountPrice ? styles.disabledPrice : ""
                    }
                  >
